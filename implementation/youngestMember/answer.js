const people = [{ name: 'Tommy', age: 20 }, { name: 'Timmy', age: 10 }, { name: 'Jimmy', age: 14 }];
...
const youngestMember = people => people.reduce((acc, person) => (acc.age > person.age ? acc.name : person.name));
